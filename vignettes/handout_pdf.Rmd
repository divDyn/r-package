---
title: "Handout to the R package divDyn v0.8.3 for diversity dynamics using fossil sampling data"
author: "Adam T. Kocsis, Carl J. Reddin, Wolfgang Kiessling"
date: '`r Sys.Date()`'
output: pdf_document
vignette: >
  %\VignetteIndexEntry{Handout to the R packare divDyn v0.8.3 for diversity dynamics using fossil sampling data}
...
```{r tsplot1, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r tsplot2, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r tsplot3, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
tsplot(stages, boxes="sys", shading="series", 
...
```{r tsplot4, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r tsplot5, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r tsplot6, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
tsplot(stages, boxes=c("short","system"), shading="short", 
...
```{r ranplot, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r ranplot2, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r ranplot3, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r ranplot4, echo= TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
tsplot(stages, shading="stage", boxes=c("stage","series"),xlim=c(100,80))
...
```{r survTsplotblank, echo=TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
# time scale plot
...
```{r survTsplot1, echo=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# time scale plot
tsplot(stages, shading="series", boxes="sys", xlim=c(260,0),
...
```{r survTsplot2, echo=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r occsAndColls, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r parts, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r parts2, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r parts3, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r ddRec, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# metrics
...
```{r ddFossils, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# metrics
...
```{r ddDiv, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# metrics
dd <-divDyn(fossils, bin="stg", tax="genus")
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r samp3t, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r ddCorr, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r ddExt, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r selPrim, echo=TRUE, results=TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r selFirst, echo=TRUE, results=TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r sel2, echo=TRUE, results=TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r sel3, echo=TRUE, results=TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```
```{r selDotShow, echo=FALSE, results=TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
# split by ecology
  z<- fossils[fossils$ecology=="z",]
  az<- fossils[fossils$ecology=="az",]
...
```{r ddMid, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r ddBasic, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r slicing, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# resolve time
...
```{r slicedd, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r dd10, echo=TRUE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r dd10actual, echo=FALSE, result=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
    ylab="Diversity, range-through", ylim=c(0,300))
  lines(ddIDbin$mid_ma, ddIDbin$divRT, col="black", lwd=2)
...
```{r ddCRBasic, echo=TRUE, results=FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r subIter, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r subDupl, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
## subsampled, stable  
...
```{r subFail, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
    ylab="number of occurrences", ylim=c(0,100))
...
```{r subIntact, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r subOutput, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# basic plot
  tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r subMultiRes, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r shades, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
tsplot(stages, shading="series", boxes="sys", xlim=52:95,
  ylab="subsampled richness of genera (corrected SIB)", ylim=c(0,150))
...
```{r shades100, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
tsplot(stages, shading="series", boxes="sys", xlim=52:95,
  ylab="subsampled richness of genera (corrected SIB)", ylim=c(0,150))
...
```{r subOCC, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
OCC <- function(x) table(x$stg)
...
```{r rawPL, echo=TRUE, results=TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
PL <- function(x){
...
```{r subPL, echo=TRUE, results =TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r subPLSmm, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r subOW, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r subST, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
subST <- subsample(fossGen, bin="stg", tax="genus", coll="collection_no", 
  iter=100, q=20,FUN=binstat, type="oxw")

```
```{r subSTshow, echo=TRUE, results =TRUE, plot=TRUE, fig.height=5.5, fig.width=7}
subST[54:94, "occs"]
```
...
```{r subO2, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r subCRmany, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r subCRmanyShow, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
tsplot(stages, shading="series", boxes="sys", xlim=52:95,
...
```{r sqs1, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
# sqs with 0.6 quorum
...
```{r sqs2, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r sqs3, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}
...
```{r sqsColl, echo=TRUE, results =FALSE, plot=TRUE, fig.height=5.5, fig.width=7}

---
title: "Handout to the R package divDyn v0.5.2 for diversity dynamics from fossil occurrence data"
author: "Adam T. Kocsis, Carl J. Reddin, Wolfgang Kiessling"
date: '`r Sys.Date()`'
output: pdf_document
vignette: >
  %\VignetteIndexEntry{Handout to the R package divDyn v0.5.2 for diversity dynamics from fossil occurrence data}
...
This dataset was resolved to the 10 my timescale of the PaleoDB (``BIN``, now only available through FossilWorks) and the stage-level time scale (variable ``stg``) that is included in the package (see Section 2.1, ``stages``). 
...
samp <-sampstat(fossils, tax="genus", bin="stg", 
...
sam <-sampstat(fossils, bin="stg", tax="genus", coll="collection_no", duplicates=F)

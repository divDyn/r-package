---
title: "Handout to the R package divDyn v0.7.0 for diversity dynamics using fossil sampling data"
author: "Adam T. Kocsis, Carl J. Reddin, Wolfgang Kiessling"
date: '`r Sys.Date()`'
output: pdf_document
vignette: >
  %\VignetteIndexEntry{Handout to the R package divDyn v0.7.0 for diversity dynamics using fossil sampling data}
...
Instead of spending it on actual research, a tremendous amount of time was invested in making this piece of software useable and user-friendly. If you use a method implemented in the package in a publication, please cite both its reference(s) and the 'divDyn' package itself (Kocsis et al. 2018).
...
Kocsis, A. T., Reddin, C. J., Alroy, J. and Kiessling, W. (2018). The R package divDyn for quantifying diversity dynamics using fossil sampling data. bioRxiv. https://doi.org/10.1101/423780

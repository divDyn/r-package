...
#' 	\item{\code{authorizer}}{Authorizer of the occurrence record in the PaleoDB.}
...
#' 	\item{\code{zone}}{Registered biozone of the collection.}
#' 	\item{\code{formation}}{Registered formation of the collection.}

---
title: "Handout to the R package 'divDyn' v0.5.0 for diversity dynamics from fossil occurrence data"
author: "Adam T. Kocsis, Carl J. Reddin, Wolfgang Kiessling"
date: '`r Sys.Date()`'
output: pdf_document
vignette: >
  %\VignetteIndexEntry{Handout to the R package 'divDyn' v0.5.0 for diversity dynamics from fossil occurrence data}
...
sam <-sampstat(fossils, bin="slc", tax="genus", coll="collection_no", duplicates=F)
...
subUWunit <- subsample(fossGen, bin="slc", tax="genus", 

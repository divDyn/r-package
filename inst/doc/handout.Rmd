---
title: "Handout to the R package divDyn v0.6.0 for diversity dynamics from fossil sampling data"
author: "Adam T. Kocsis, Carl J. Reddin, Wolfgang Kiessling"
date: '`r Sys.Date()`'
output: pdf_document
vignette: >
  %\VignetteIndexEntry{Handout to the R package divDyn v0.6.0 for diversity dynamics from fossil sampling data}

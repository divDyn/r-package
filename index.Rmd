...
`r badge_devel("divDyn/divDyn", "green")`
...
- How-to guides on combining the package's capabilities with other packages are deposited on the [evolvED blog](https://www.evolv-ed.net/).
